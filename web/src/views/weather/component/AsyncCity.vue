...
<template>
  <div class="flex flex-col items-center flex-1 ">
    <div v-if="$route.query.preview" class="w-full p-4 text-center text-white bg-weather-secondary">
      <p>You are currently previewing this city, click the "+" to start tracking this city.</p>
    </div>
    <div class="flex flex-col items-center py-12 text-white">
      ...
      <img :src="`http://openweathermap.org/img/wn/${weatherData.current.weather[0].icon}@4x.png`" class="w-[150px] h-auto" alt="">
    </div>
