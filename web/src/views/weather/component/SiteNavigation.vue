<template>
  <header class="sticky top-0 shadow-lg bg-weather-primary">
    <nav class="container flex flex-col items-center gap-4 py-6 text-white sm:flex-row">
      ...
      <div class="flex justify-end flex-1 gap-3">
        <i @click="toggleModal" class="text-xl duration-150 cursor-pointer fa-solid fa-circle-info hover:text-weather-secondary"></i>
  ...
  <BaseModal :modalValue="isModal" @closeModal="toggleModal">
    <div>
      ...
      <p class="mb-4">The Local Weather allows you to track the current and future weather or cities of your choosing.</p>
      <h2 class="text-2xl">How it works:</h2>
      <ol  class="mb-4 list-decimal list-inside">
        <li>Search for your city by entering the name into the search bar.</li>
        <li>Select a city by clicking the "+" icon in the top right. This will save the city to view at o later time on the home page.</li>
      </ol>
